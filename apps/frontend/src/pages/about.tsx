    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-6 py-10">
        ...
        <p className="text-lg text-gray-300 mb-6 leading-relaxed">
          <strong>IntoTurnOne</strong> is an independent Formula 1 hub created by a lifelong fan and engineer who wanted more than just race results — a place where real-time data, strategy breakdowns, and F1 passion collide.
        </p>
